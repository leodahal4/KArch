...
"x86_64-linux-thread-multi-5.7.8-arch1-1" or
	die "Errno architecture (x86_64-linux-thread-multi-5.7.8-arch1-1) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
